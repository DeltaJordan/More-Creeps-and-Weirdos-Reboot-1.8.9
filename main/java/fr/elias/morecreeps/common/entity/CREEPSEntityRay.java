...
public class CREEPSEntityRay extends Entity
{
    ...
    public CREEPSEntityRay(World world, EntityLivingBase entityliving, float f)
    {
        this(world);
        ...
        if ((entityliving instanceof CREEPSEntityFloob) || (entityliving instanceof CREEPSEntitySneakySal))
        {
        ...
        func_22374_a(motionX, motionY, motionZ, (float)(1.3799999952316284D + ((double)worldObj.rand.nextFloat() - 0.5D)), f1);
    }
    ...
    public void onUpdate()
    {
        ...
        if (movingobjectposition != null)
        {
            ...
            else
            {
                ...
                if (CREEPSConfig.rayGunMelt && rand.nextInt(5) == 0 && worldObj.getBlockState(new BlockPos(hitX, hitY, hitZ)).getBlock() != Blocks.bedrock)
                {
                ...
                if (CREEPSConfig.rayGunFire && blockHit == Blocks.glass.getDefaultState())
                {
                    ...
                    if(side == Side.CLIENT)
                    {
                    	FMLClientHandler.instance().getClient().effectRenderer.func_180533_a(new BlockPos(hitX, hitY, hitZ), Blocks.glass.getDefaultState());
                    }
                }
