	...
	EntityPlayer player;
		...
		@SubscribeEvent
	 	public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
			...
			event.player.addChatComponentMessage(new ChatComponentText("More Creeps and Weirdos Version " + Reference.MOD_VERSION + " for MC " + Reference.MOD_MC_VERSION + " has been loaded"));
