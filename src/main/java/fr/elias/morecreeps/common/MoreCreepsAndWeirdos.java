...
public class MoreCreepsAndWeirdos
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
        ...
        aX = -2;
        aY = 15;
//		  achievefrisbee = (new Achievement("frisbee", "frisbee", aX, aY, frisbee, null)).registerAchievement();
//        achievechugcola = (new Achievement("chugcola", "chugcola", aX + 2, aY, blorpcola, null)).registerAchievement();
//        achieveradio = (new Achievement("guineapigradio", "guineapigradio", aX + 4, aY, guineapigradio, null)).registerAchievement();
//        achievepyramid = (new Achievement("pyramid", "pyramid", aX + 6, aY, a_pyramid, null)).registerAchievement();
//        achievelolliman = (new Achievement("lolliman", "lolliman", aX + 8, aY, lolly, null)).registerAchievement();
//        achievesnowdevil = (new Achievement("snowdevil", "snowdevil", aX + 2, aY + 2, Blocks.ice, null)).registerAchievement();
//        achievehunchback = (new Achievement("hunchback", "hunchback", aX + 4, aY + 2, Items.cake, null)).registerAchievement();
//        achievecamel = (new Achievement("camel", "camel", aX + 6, aY + 2, a_camel, achievecamel)).registerAchievement();
//        achievezebra = (new Achievement("zebra", "zebra", aX + 8, aY + 2, a_zebra, achievezebra)).registerAchievement();
//        achieverockmonster = (new Achievement("rockmonster", "rockmonster", aX, aY + 2, a_rockmonster, null)).registerAchievement();
//        achieveschlump = (new Achievement("schlump", "schlump", aX, aY + 4, babyjarfull, achieveschlump)).registerAchievement();
//        achievenonswimmer = (new Achievement("nonswimmer", "nonswimmer", aX + 2, aY + 4, a_nonswimmer, achievenonswimmer)).registerAchievement();
//        achievepigtaming = (new Achievement("pigtaming", "pigtaming", aX, aY + 6, a_pig, null)).registerAchievement();
//        achievepiglevel5 = (new Achievement("level5", "level5", aX + 2, aY + 6, a_pig, achievepigtaming)).registerAchievement();
//        achievepiglevel10 = (new Achievement("level10", "level10", aX + 4, aY + 6, a_pig, achievepiglevel5)).registerAchievement();
//        achievepiglevel20 = (new Achievement("level20", "level20", aX + 6, aY + 6, a_pig, achievepiglevel10)).registerAchievement();
//        achievepighotel = (new Achievement("pighotel", "pighotel", aX + 8, aY + 6, a_pig, achievepiglevel20)).registerAchievement();
//        achieverocketgiraffe = (new Achievement("rocketgiraffe", "rocketgiraffe", aX, aY + 8, rocket, null)).registerAchievement();
//        achieverocket = (new Achievement("rocket", "rocket", aX + 2, aY + 8, rocket, achieverocketgiraffe)).registerAchievement();
//        achieverocketrampage = (new Achievement("rocketrampage", "rocketrampage", aX + 4, aY + 8, rocket, achieverocket)).registerAchievement();
//        achievefloobkill = (new Achievement("floobkill", "floobkill", aX, aY + 10, a_floob, null)).registerAchievement();
//        achievefloobicide = (new Achievement("floobicide", "floobicide", aX + 2, aY + 10, a_floob, achievefloobkill)).registerAchievement();
//        achievegookill = (new Achievement("gookill", "gookill", aX, aY + 12, goodonut, null)).registerAchievement();
//        achievegookill10 = (new Achievement("gookill10", "gookill10", aX + 2, aY + 12, goodonut, achievegookill)).registerAchievement();
//        achievegookill25 = (new Achievement("gookill25", "gookill25", aX + 4, aY + 12, goodonut, achievegookill10)).registerAchievement();
//        achievebumflower = (new Achievement("bumflower", "bumflower", aX, aY + 14, Blocks.yellow_flower, null)).registerAchievement();
//        achievebumpot = (new Achievement("bumpot", "bumpot", aX + 2, aY + 14, Items.bucket, achievebumflower)).registerAchievement();
//        achievebumlava = (new Achievement("bumlava", "bumlava", aX + 4, aY + 14, Items.lava_bucket, achievebumpot)).registerAchievement();
//        achieve100bucks = (new Achievement("achieve100bucks", "achieve100bucks", aX, aY + 16, money, null)).registerAchievement();
//        achieve500bucks = (new Achievement("achieve500bucks", "achieve500bucks", aX + 2, aY + 16, money, achieve100bucks)).registerAchievement();
//        achieve1000bucks = (new Achievement("achieve1000bucks", "achieve1000bucks", aX + 4, aY + 16, money, achieve500bucks)).registerAchievement();
//        achieve10bubble = (new Achievement("achieve10bubble", "achieve10bubble", aX, aY + 18, a_bubble, null)).registerAchievement();
//        achieve25bubble = (new Achievement("achieve25bubble", "achieve25bubble", aX + 2, aY + 18, a_bubble, achieve10bubble)).registerAchievement();
//        achieve50bubble = (new Achievement("achieve50bubble", "achieve50bubble", aX + 4, aY + 18, a_bubble, achieve25bubble)).registerAchievement();
//        achieve100bubble = (new Achievement("achieve100bubble", "achieve100bubble", aX + 6, aY + 18, a_bubble, achieve50bubble)).registerAchievement();
//        achievesnow = (new Achievement("achievesnow", "achievesnow", aX, aY + 20, Items.snowball, null)).registerAchievement();
//        achievesnowtiny = (new Achievement("achievesnowtiny", "achievesnowtiny", aX + 2, aY + 20, Items.snowball, null)).registerAchievement();
//        achievesnowtall = (new Achievement("achievesnowtall", "achievesnowtall", aX + 4, aY + 20, Items.snowball, null)).registerAchievement();
//        achievehotdogtaming = (new Achievement("hotdogtaming", "hotdogtaming", aX, aY + 22, a_hotdog, null)).registerAchievement();
//        achievehotdoglevel5 = (new Achievement("hotdoglevel5", "level5", aX + 2, aY + 22, a_hotdog, achievehotdogtaming)).registerAchievement();
//        achievehotdoglevel10 = (new Achievement("hotdoglevel10", "level10", aX + 4, aY + 22, a_hotdog, achievehotdoglevel5)).registerAchievement();
//        achievehotdoglevel25 = (new Achievement("hotdoglevel25", "level25", aX + 6, aY + 22, a_hotdog, achievehotdoglevel10)).registerAchievement();
//        achievehotdogheaven = (new Achievement("hotdogheaven", "hotdogheaven", aX + 8, aY + 22, a_hotdog, achievehotdoglevel25)).registerAchievement();
//        achieveram128 = (new Achievement("ram128", "ram128", aX, aY + 24, ram16k, null)).registerAchievement();
//        achieveram512 = (new Achievement("ram512", "ram512", aX + 2, aY + 24, ram16k, achieveram128)).registerAchievement();
//        achieveram1024 = (new Achievement("ram1024", "ram1024", aX + 4, aY + 24, ram16k, achieveram512)).registerAchievement();
//        achievegotohell = (new Achievement("gotohell", "gotohell", aX, aY + 26, a_hell, null)).registerAchievement();
//        achievefalseidol = (new Achievement("falseidol", "falseidol", aX + 2, aY + 26, a_hell, achievegotohell)).registerAchievement();
//        achieveprisoner = (new Achievement("achieveprisoner", "achieveprisoner", aX, aY + 28, Blocks.iron_bars, null)).registerAchievement();
//        achieve5prisoner = (new Achievement("achieve5prisoner", "achieve5prisoner", aX + 2, aY + 28, Blocks.iron_bars, achieveprisoner)).registerAchievement();
//        achieve10prisoner = (new Achievement("achieve10prisoner", "achieve10prisoner", aX + 4, aY + 28, Blocks.iron_bars, achieve5prisoner)).registerAchievement();
//        achieve1caveman = (new Achievement("achieve1caveman", "achieve1caveman", aX, aY + 30, a_caveman, null)).registerAchievement();
//        achieve10caveman = (new Achievement("achieve10caveman", "achieve10caveman", aX + 2, aY + 30, a_caveman, achieve1caveman)).registerAchievement();
//        achieve50caveman = (new Achievement("achieve50caveman", "achieve50caveman", aX + 4, aY + 30, a_caveman, achieve10caveman)).registerAchievement();
